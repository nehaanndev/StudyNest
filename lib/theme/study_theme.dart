...
const studyThemes = [
  ...
  StudyVisualTheme(
    ...
    primary: Color(0xFF88B7C7),
    secondary: Color(0xFF6F8F84),
    accent: Color(0xFFE1B464),
    text: Color(0xFFF0E6D4),
    muted: Color(0xFF9AA8AF),
  ),
  StudyVisualTheme(
    id: 'midnightCity',
    name: 'Midnight City',
  ...
  StudyVisualTheme(
    ...
    emoji: '🏛️',
    background: Color(0xFF100B06),
    surface: Color(0xFF1E160C),
    surfaceAlt: Color(0xFF2B2113),
    primary: Color(0xFFD8B36A),
    secondary: Color(0xFF9B7650),
    accent: Color(0xFF7FA08A),
    text: Color(0xFFFFF2D8),
    muted: Color(0xFFB89B75),
  ),
];
